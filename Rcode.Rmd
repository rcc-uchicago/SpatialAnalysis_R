...
Introduction
========================================================
R is an open-source language for statistical computing. A good way to think about R is as a core package, to which a library, consisting of additional packages, can be attached to increase its functionality. R can be downloaded for free at:
...
knitr::include_graphics("slides-figure/Ellipsoid.png")
```
